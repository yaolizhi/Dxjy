...
#define kMaskViewColor WLColor(0, 0, 0, 0.4)
#define kTitleAndMsgColor UIColorFromRGB(0x333333)
//#define kButtonTitleColor UIColorFromRGB(0x333333)
...
//        self.backgroundColor = [UIColor colorWithWhite:0.8 alpha:0.6];
        self.backgroundColor = kMaskViewColor;
        ...
        if (title) {
            ...
            self.titleLbl.textColor = kTitleAndMsgColor;
        ...
        if (message) {
            ...
            self.msgLbl.textColor = kTitleAndMsgColor;
        ...
        if (cancleTitle && sureTitle) {
            ...
            [self.cancleBtn setTitleColor:kTitleAndMsgColor forState:UIControlStateNormal];
        ...
        if(sureTitle && cancleTitle){
            ...
            [self.sureBtn setTitleColor:kTitleAndMsgColor forState:UIControlStateNormal];
...
- (void)cancelAction:(UIButton *)sender {
    self.cancelBlock(_msgLbl.text);
    [self removeFromSuperview];
}

- (void)sureAction:(UIButton *)sender {
    self.sureBlock(_msgLbl.text);
    [self removeFromSuperview];
}
...
-(UILabel *)GetAdaptiveLable:(CGRect)rect AndText:(NSString *)contentStr andIsTitle:(BOOL)isTitle
{
    ...
    if (isTitle) {
        contentLbl.font = [UIFont boldSystemFontOfSize:ScaleW(16.0)];
    }else{
        contentLbl.font = [UIFont systemFontOfSize:ScaleW(14.0)];
    }
