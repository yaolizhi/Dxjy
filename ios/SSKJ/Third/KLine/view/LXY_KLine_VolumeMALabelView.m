...
-(void)showLabelWithModel:(LXY_KLine_DataModel *)model
{
    ...
    NSString *volString = [@"VOL:" stringByAppendingString:[WLTools noroundingStringWith:model.volume.doubleValue afterPointNumber:2]];
    NSString *ma5String = [@"MA5:" stringByAppendingString:[WLTools noroundingStringWith:model.volume_MA5 afterPointNumber:2]];
    NSString *ma10String = [@"MA10:" stringByAppendingString:[WLTools noroundingStringWith:model.volume_MA5 afterPointNumber:2]];
