...
//        CGFloat width = [WLTools getWidthWithText:priceString font:WLFontSize(10)]  + 10;
...
-(void)refreshCurrentPricelabel
{
    ...
    NSString *currentPrice = [NSString stringWithFormat:formate,self.lastModel.close.doubleValue];
