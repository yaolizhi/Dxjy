...
//        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:ScaleW(15)];
        [_leftBtn setTitleColor:[UIColor colorWithHexString:@"#9a9a9a"] forState:UIControlStateNormal];
...
//        _rightBtn.layer.masksToBounds = YES;
        _rightBtn.titleLabel.font = [UIFont systemFontOfSize:ScaleW(15)];
        [_rightBtn setTitleColor:[UIColor colorWithHexString:@"#9a9a9a"] forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont systemFontOfSize:ScaleW(14)];
