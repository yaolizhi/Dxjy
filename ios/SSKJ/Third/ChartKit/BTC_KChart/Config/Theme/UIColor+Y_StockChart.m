...
{
    return [UIColor colorWithRGBHex:0x131f30];;
}
...
{
    return [UIColor colorWithRGBHex:0x6a83aa];
}
...
+(UIColor *)ma5Color
{
    return [UIColor colorWithRGBHex:0xAF1DB4];
}

#pragma mark ma30颜色
+(UIColor *)ma10Color
{
    return [UIColor colorWithRGBHex:0xDEDC30];
}

+(UIColor *)ma20Color
{
    return [UIColor colorWithRGBHex:0x79B7E0];
}
