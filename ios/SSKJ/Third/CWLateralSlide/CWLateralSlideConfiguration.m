...
+ (instancetype)defaultConfiguration {
    return [CWLateralSlideConfiguration configurationWithDistance:kCWSCREENWIDTH * 0.85 maskAlpha:0.4 scaleY:1.0 direction:CWDrawerTransitionFromLeft backImage:nil];
}
