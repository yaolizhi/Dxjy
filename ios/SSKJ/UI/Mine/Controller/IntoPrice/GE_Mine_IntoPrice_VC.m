...
@interface GE_Mine_IntoPrice_VC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation GE_Mine_IntoPrice_VC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell initModel:self.dataSource[indexPath.row] type:1];
