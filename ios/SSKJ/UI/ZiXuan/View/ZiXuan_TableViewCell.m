...
@implementation ZiXuan_TableViewCell
...
- (UIButton *)deletedBtn{
    if (_deletedBtn == nil) {
        _deletedBtn = [FactoryUI createButtonWithFrame:CGRectZero title:nil titleColor:nil imageName:@"ZiXuan_shanchu" backgroundImageName:nil target:self selector:@selector(deletedBtnAction) font:nil];
...
-(UILabel *)coinNameLabel
{
    if (_coinNameLabel==nil)
    {
        ...
        _coinNameLabel.frame = CGRectMake(ScaleW(15), ScaleW(15), ScaleW(100), ScaleW(20));
...
-(UILabel *)codeLabel
{
    if (_codeLabel==nil)
    {
        ...
        _codeLabel.frame = CGRectMake(ScaleW(15), ScaleW(75) - ScaleW(35), ScaleW(100), ScaleW(20));
...
-(UIButton *)rateButton
{
    if (_rateButton==nil)
    {
        ...
        _rateButton.titleLabel.font=WLFontSize(ScaleW(14.0));
...
-(UILabel *)priceLabel
{
    if (_priceLabel==nil)
    {
        ...
        [_priceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.centerX.equalTo(self.contentView.mas_centerX).offset(ScaleW(20));
...
- (void)initDatawithModel:(Market_Main_List_Model *)model index:(NSInteger)index{
    ...
    if (index == 1) {
        ...
        self.coinNameLabel.x = ScaleW(15);
        self.codeLabel.x = ScaleW(15);
    }else{
        self.deletedBtn.hidden = NO;
        self.coinNameLabel.x = ScaleW(45);
        self.codeLabel.x = ScaleW(45);
    }
...
- (void)deletedBtnAction{
    if (self.OptionalDelBlock) {
        self.OptionalDelBlock(self.model);
    }
}
